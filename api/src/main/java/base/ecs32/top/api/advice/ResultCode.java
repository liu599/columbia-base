...
public enum ResultCode {
	...
	// ----- 知识库相关错误 (47000-47999) -----
	KB_NOT_FOUND(47001, "知识库不存在"),
	KB_NO_PERMISSION(47002, "无权限访问此知识库"),
	KB_FILE_NOT_FOUND(47003, "知识库文件关联不存在"),
	KB_FILE_ALREADY_EXISTS(47004, "文件已存在于知识库中"),
	KB_FILE_STATUS_INVALID(47005, "无效的文件状态"),
